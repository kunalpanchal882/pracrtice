...
export { AwsRequestSigner, AwsSecurityCredentials } from 'google-auth-library/build/src/auth/awsrequestsigner';
export { BaseExternalAccountClient, BaseExternalAccountClientOptions, ExternalAccountSupplierContext, IamGenerateAccessTokenResponse, SharedExternalAccountClientOptions } from 'google-auth-library/build/src/auth/baseexternalclient';
...
export { Certificates, ClientAuthentication, CodeChallengeMethod, CodeVerifierResults, GenerateAuthUrlOpts, GetTokenOptions, OAuth2Client, OAuth2ClientOptions, RefreshOptions, TokenInfo, VerifyIdTokenOptions } from 'google-auth-library/build/src/auth/oauth2client';
export { PassThroughClient } from 'google-auth-library/build/src/auth/passthrough';
export { ExecutableError, PluggableAuthClient, PluggableAuthClientOptions } from 'google-auth-library/build/src/auth/pluggable-auth-client';
