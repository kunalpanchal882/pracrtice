...
import { AuthClient, AuthClientOptions } from 'google-auth-library/build/src/auth/authclient';
import { BaseExternalAccountClient } from 'google-auth-library/build/src/auth/baseexternalclient';
import { CredentialBody, ImpersonatedJWTInput, JWTInput } from 'google-auth-library/build/src/auth/credentials';
...
import { Impersonated, ImpersonatedOptions } from 'google-auth-library/build/src/auth/impersonated';
import { JWT, JWTOptions } from 'google-auth-library/build/src/auth/jwtclient';
import { Headers, OAuth2ClientOptions } from 'google-auth-library/build/src/auth/oauth2client';
import { UserRefreshClient, UserRefreshClientOptions } from 'google-auth-library/build/src/auth/refreshclient';
import { DefaultTransporter, Transporter } from 'google-auth-library/build/src/transporters';
